...
alter git repository database_common.public.database_repo fetch;
-- Deploy the updated data pipeline
execute immediate from @database_common.public.database_repo/branches/dev/deploy_pipeline.sql;
