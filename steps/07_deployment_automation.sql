...
show parameters like 'data_retention_time_in_days' in table database_dev.gold.vacation_spots;
-- should return 1 (due to deploy_pipeline_dev.yml)
show parameters like 'data_retention_time_in_days' in table database_prod.gold.vacation_spots;
