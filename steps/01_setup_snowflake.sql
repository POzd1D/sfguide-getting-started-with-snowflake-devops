...
CREATE OR REPLACE API INTEGRATION git_api_integration
  ...
  API_ALLOWED_PREFIXES = ('https://github.com/POzd1D') -- INSERT YOUR GITHUB USERNAME HERE
  ENABLED = TRUE;
...
CREATE OR REPLACE GIT REPOSITORY database_common.public.database_repo
  ...
  ORIGIN = 'https://github.com/POzd1D/snowflake-devops'; -- INSERT URL OF FORKED REPO HERE
